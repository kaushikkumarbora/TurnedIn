...
VALUES ('Kaushik', 'Kumar Bora', '2001-01-17', 'kaushikkumarbora@gmail.com', '9999999999', 'C, C++, Golang', '2018', '2022', 7, 'Hey', (select por_id from por where name='Jorhat'), 'B.Tech, M.Tech, PhD', 'CSE', 'B.Tech', 'CMH', true, 'kaushik', 'kaushik123', 'blablabla'),
('Aasurjya', 'Bikash Handique', '2001-01-17', 'ahandique8@gmail.com', '9999999999', 'C, C++, Golang', '2018', '2022', 7, 'Hey', (select por_id from por where name='Dibrugarh'), 'B.Tech, M.Tech, PhD', 'CSE', 'B.Tech', 'CMH', true, 'shivangshu', 'shivangshu123', 'blablabla'),
('Mithuraj', 'Borgohain', '1997-02-13', 'mithuraj@gmail.com', '9999999999', 'C, C++, Golang', '2018', '2022', 7, 'Hey', (select por_id from por where name='Dhemaji'), 'B.Tech, M.Tech, PhD', 'FET', 'B.Tech', 'CMH', true, 'mithuraj', 'mithuraj123', 'blablabla');
